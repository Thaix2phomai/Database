...
```sql
insert into employee (id, name, date_of_birth, gender, address, mobile, email, position) values  (1,'Thái','2000-22-06','Male','Hà Nội',0394106474,'thai@gmail.com','Dịch vụ');
insert into employee (id, name, date_of_birth, gender, address, mobile, email, position) values (2,'Khải','2000-30-10','Male','Hà Nội',0989980116,'khai@gmail.com','Dịch Vụ');
insert into employee (id, name, date_of_birth, gender, address, mobile, email, position) values (3,'Cường','2000-15-03','Male','Hà Nội',0913248597,'cuong@gmail.com','Dọn Bàn');
insert into employee (id, name, date_of_birth, gender, address, mobile, email, position) values (4,'Dung','2000-20-04','Female','Hà Nội',0367374937,'dung@gmail.com','Soát Vé');
insert into employee (id, name, date_of_birth, gender, address, mobile, email, position) values (5,'Hương','2000-05-07','Female','Hà Nội',0388817229,'huong@gmail.com','Soát Vé');
```
**2.Thêm data bảng ca làm việc**
```sql
insert into shift (id, shift_type, start, end, month, salary_per_day) values (1, 'Morning', '8:00:00', '13:00:00', 1, 100000);
insert into shift (id, shift_type, start, end, month, salary_per_day) values (2, 'Afternoon', '13:00:00', '17:00:00', 1, 100000);
insert into shift (id, shift_type, start, end, month, salary_per_day) values (3, 'Night', '17:00:00', '22:00:00', 1, 120000);
insert into shift (id, shift_type, start, end, month, salary_per_day) values (4, 'Full-time', '8:00:00', '5:00:00', 1, 150000);
```
**3.Thêm data bảng lương thưởng**
```sql
insert into bonus (id, name, bonus_money) values(1, 'Nhân viên chăm chỉ của tháng', 70000);
...
insert into bonus (id, name, bonus_money) values(4,'Nhân viên thân thiện', 30000);
insert into bonus (id, name, bonus_money) values(5, 'Thưởng tết', 100000);
```
...
insert into punish (id, name, punish_money) values(3, 'Không mặc đồng phục', 300000);
insert into punish (id, name, punish_money) values(4, 'Làm hỏng thiết bị', 5000000);
...
insert into employee_bonus(id, id_employee, id_bonus, bonus_number, bonus_date, total_bonus_money) values(5, 5, 2, 1 ,'2021-06-07');
```
...
insert into employee_punish(id, id_employee, id_punish, punish_number, punish_date, total_punish_money) values(4, 4, 4, 1,'2021-12-01');
...
```sql
insert into full_salary(id_salary, id_employee_bonus, id_employee_punish, month, total_salary) values(1, 1, 1, '1',3000000);
insert into full_salary(id_salary, id_employee_bonus, id_employee_punish, month, total_salary) values(2, 2, 2, '1',2260000);
insert into full_salary(id_salary, id_employee_bonus, id_employee_punish, month, total_salary) values(3, 3, 3, '1', 3570000);
...
insert into format (id, format) values (3, 'IMAX');
insert into format (id, format) values (4, '4DX');
insert into format (id, format) values (5, 'Starium Laser');
...
```sql
insert into film (id, id_producer, title, director, poster, description, length, rating, status) values (1, 1, 'Snow White and the Huntsman', 'Dick Rosiello', '', '', 235, 'PG', 'Release');
insert into film (id, id_producer, title, director, poster, description, length, rating, status) values (2, 2, 'Doctor at Sea', 'Katherine Tindle', '', '', 138,'G', 'Release');
insert into film (id, id_producer, title, director, poster, description, length, rating, status) values (3, 3, 'Great Day in the Morning', 'Sheela Whittlesea', '', '', 137, 3, 'Coming Soon');
insert into film (id, id_producer, title, director, poster, description, length, rating, status) values (4, 4, 'My Summer of Love', 'Orelle Arrundale', '', '', 263, 'G', 'Release');
insert into film (id, id_producer, title, director, poster, description, length, rating, status) values (5, 5, 'Deal, The', 'Dina Cossem', '', '', 263, 'NC-17', 'Coming Soon');
```
...
**23.Thêm data bảng ticket**
```sql
insert into ticket (id, id_employee, id_customer, id_film, id_room, id_seat, cinema_address, time_start) values (1, 1, 1, 1, 1, 1, '40601 Melrose Avenue', '5:07:00');
insert into ticket (id, id_employee, id_customer, id_film, id_room, id_seat, cinema_address, time_start) values (2, 2, 2, 2, 2, 2, '6 Everett Avenue', '10:03:00');
insert into ticket (id, id_employee, id_customer, id_film, id_room, id_seat, cinema_address, time_start) values (3, 3, 3, 3, 3, 3, '37567 Leroy Parkway', '5:07:00');
insert into ticket (id, id_employee, id_customer, id_film, id_room, id_seat, cinema_address, time_start) values (4, 4, 4, 4, 4, 4, '426 Logan Road', '1:24:00');
insert into ticket (id, id_employee, id_customer, id_film, id_room, id_seat, cinema_address, time_start) values (5, 5, 5, 5, 5, 5, '38228 Becker Lane', '12:25:00');
```
**24.Thêm data bảng hóa đơn khách hàng**
```sql
insert into ticket_bill (id, date_bill, time_bill, id_ticket, id_ticket_type, id_discount, number_of_tickets, total_bill) values (1, '2021/04/12', '6:43:00', 1, 1, 1, 10, 100000);
insert into ticket_bill (id, date_bill, time_bill, id_ticket, id_ticket_type, id_discount, number_of_tickets, total_bill) values (2, '2021/06/01', '1:42:00', 2, 2, 2, 1, 200000);
insert into ticket_bill (id, date_bill, time_bill, id_ticket, id_ticket_type, id_discount, number_of_tickets, total_bill) values (3, '2021/07/15', '4:01:00', 3, 3, 3, 5, 250000);
insert into ticket_bill (id, date_bill, time_bill, id_ticket, id_ticket_type, id_discount, number_of_tickets, total_bill) values (4, '2021/12/05', '9:28:00', 4, 4, 4, 9, 178000);
insert into ticket_bill (id, date_bill, time_bill, id_ticket, id_ticket_type, id_discount, number_of_tickets, total_bill) values (5, '2021/05/5', '4:07:00', 5, 5, 5, 5, 194000);
```
...
```sql
insert into import_goods (id, name, production_date, expiration_date) values (1, 'Cốc', '2019/07/21', '2021/12/05');
insert into import_goods (id, name, production_date, expiration_date) values (2, 'Ống hút', '2019/07/12', '2021/03/15');
insert into import_goods (id, name, production_date, expiration_date) values (3, 'Bắp', '2019/07/17', '2021/07/20');
insert into import_goods (id, name, production_date, expiration_date) values (4, 'Coca', '2019/06/28', '2021/09/18');
insert into import_goods (id, name, production_date, expiration_date) values (5, 'Bơ thực vật', '2019/03/20', '2021/05/30');
```

**28.Thêm data bảng detail_import_ticket**
```sql
insert into detail_import_ticket (id_import_ticket, id_import_goods, quantity_of_goods, money_per_goods) values (1, 1, 96, 721276);
insert into detail_import_ticket (id_import_ticket, id_import_goods, quantity_of_goods, money_per_goods) values (2, 2, 85, 646220);
insert into detail_import_ticket (id_import_ticket, id_import_goods, quantity_of_goods, money_per_goods) values (3, 3, 44, 102076);
insert into detail_import_ticket (id_import_ticket, id_import_goods, quantity_of_goods, money_per_goods) values (4, 4, 99, 555624);
insert into detail_import_ticket (id_import_ticket, id_import_goods, quantity_of_goods, money_per_goods) values (5, 5, 26, 638148);
```
...
```sql
insert into bill (id, id_employee, bill_date, discount, bill_money) values (1, 1, '2020/05/22',15, 150000);
insert into bill (id, id_employee, bill_date, discount, bill_money) values (2, 2, '2020/03/02',10, 659000);
insert into bill (id, id_employee, bill_date, discount, bill_money) values (3, 3,'2020/04/30',10, 868000);
insert into bill (id, id_employee, bill_date, discount, bill_money) values (4, 4, '2020/05/02',20, 959000);
insert into bill (id, id_employee, bill_date, discount, bill_money) values (5, 5,  '2020/04/19',15, 950000);
```
